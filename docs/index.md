...
- **[lukk](https://packagist.org/packages/lukk/lukk)** — the Laravel package. Issues and verifies the tokens, owns rotation, reuse detection, the denylist, and the optional registration / 2FA / passkey / email-verification / password-reset flows.
