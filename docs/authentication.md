...
| `POST` | `/auth/session/claim` | `auth:api` | Confirm the client received a new session (lukk 0.7.0; see [`claim_seconds`](/configuration#refresh-behavior)). `204`. |
